...
Options.individualpassiveprop=0; %consider different stiffness and damper parameters for each case (each perturbation)
    Options.samepassiveprop=0; %only if previous is 0, all stiffness and damping parameters for the same pertoptInertiaParamurbation have the same values (ideal for testing variable inertia parameters for each perturbation)
