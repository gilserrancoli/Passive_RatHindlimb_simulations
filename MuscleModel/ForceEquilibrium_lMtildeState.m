function [err, FT, Fpe, FMltilde, FMvtilde, cos_alpha, lTtilde, fse_el, fse_dam] = ForceEquilibrium_lMtildeState(a,lMtilde,vMtilde,lM_projected,lMT,vMT,params,lMo,lTs,kT,shift,fiber_damping,tendon_damping)
...
vT=vMT-(vMtilde.*vMtildemax)./cos_alpha;
