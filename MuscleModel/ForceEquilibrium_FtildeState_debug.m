...
% Date: 30/07/2022
% 
function [err, FT, Fce, Fiso, vMmax, Fpetilde, lMtilde, lTtilde, vMtilde, vM, vT,cos_alpha] = ...
    ForceEquilibrium_FtildeState_debug(a,fse_el,dfse_el,lMT,vMT,FMo_m,lMo_m,lTs_m,...
