function [Fpe,FMltilde,FMvtilde,Fpe_el,Fpe_dam] = getForceLengthVelocityProperties(lMtilde,vMtilde,vMtildemax,fiber_damping,varargin)
...
Fpe_el = ((t5 - 0.10e1) - Fpparam(1)) / Fpparam(2);
Fpe_dam=fiber_damping.*(vMtilde);
